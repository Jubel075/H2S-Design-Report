...
\begin{table}[H]
\centering
\caption{Reaction kinetics for \ce{H2S} and \ce{CO2} with \ce{NaOH} at 25--40°C. Rate constants compiled from \cite{Danckwerts1965,astarita1983}; detailed derivations in \Cref{app:mass_transfer_calcs}.}
\label{tab:kinetics}
\begin{tabular}{@{}lcc@{}}
\toprule
\textbf{Reaction} & \textbf{Rate Constant} & \textbf{Regime} \\
\midrule
\ce{H2S + OH^- -> HS^- + H2O} & $k_{\ce{H2S}} \approx 10^{10}$ \si{L/(mol.s)} & Instantaneous \\
...
This analysis reveals the selectivity window: contact times of 10--100~ms allow complete \ce{H2S} absorption while limiting \ce{CO2} uptake to single-digit percentages. See \Cref{app:mass_transfer_calcs} for the complete Damk\"ohler analysis.
...
\item Design velocity: 70\% of flooding \cite{wankat2017}, $u_G \approx \SI{0.8}{m/s}$
\end{itemize}
...
\textbf{\ce{CO2} consumption (70\% absorbed at pH 12--13 \cite{AFPM2014}):}
\begin{align}
...
The SCT concept deliberately limits gas-liquid contact time to exploit the $10^6$ kinetic rate difference between \ce{H2S} and \ce{CO2} absorption \cite{AFPM2014}. By maintaining contact time in the 10--100~ms range \cite{AFPM2014,Flagiello2021}, the instantaneous \ce{H2S} reaction completes while the slower \ce{CO2} reaction achieves negligible conversion. Fig~\ref{fig:sct_pfd}, showcases the general layout for an single-stage SCT caustic scrubber. 
...
\input{Graphics/selectivity_kinetics.tex}
