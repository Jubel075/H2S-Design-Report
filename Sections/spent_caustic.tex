...
Based on the material balance from \Cref{sec:technology_options} (detailed in \Cref{app:material_balance}) and conservative design loading rates from literature \cite{odegaard2006,Vikromvarasiri2017,Borges2025}:

\begin{table}[H]
\centering
\caption{MBBR preliminary sizing for 43~kg~S/day. Detailed sizing calculations in \Cref{app:mbbr_design}.}
...
This reaction theoretically regenerates 1 mol \ce{OH^-} per mol sulfide oxidised. In practice, Borges et al.\ \cite{Borges2025} report 40--60\% alkalinity recovery, which can reduce fresh caustic makeup requirements. The alkalinity recovery calculation is detailed in \Cref{app:mbbr_design}.
