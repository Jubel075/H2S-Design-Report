...
% Drawing & Graphics
\usepackage{tikz}
\usepackage{pfdicons,chemplants}
\usetikzlibrary{
  positioning,
  arrows,
  arrows.meta,
...
\newcommand{\ReportTitle}{Selective Caustic Scrubbing Design Study for H₂S Removal at TA‑58}
...
\input{Appendix/mass_transfer_calcs}
\input{Appendix/material_balance}
\input{Appendix/economic_model}
\input{Appendix/mbbr_design}
