...
\begin{tikzpicture}[
    ...
    \node[anchor=west, font=\small\bfseries, white] at (0.06,1.0) {\$23k};
    ...
    \node[fill=white, font=\small] at (4.57,1.6) {9$\times$ cost reduction};
    ...
    % Legend note
    \node[anchor=west, font=\scriptsize, gray] at (0,-0.5) {Based on 70\% CO$_2$ absorption (packed) vs 5\% (SCT), \$500/ton NaOH};
